...
int main( int argc, char **argv ) {
  ...
  co.set_url("https://act.arlington.ma.us/cgi-bin/ACTdb/MySchedule?Proj_ID=278");
  ...
  form = co.find_form(1);
  if ( form ) {
    form->checkbox( "Chars", "2585", 1 );
    form->submit("Schedule for Laramie", "_submit", "My Schedule");
  }
  co.transaction_end();
  return 0;
}
